...
public class RbacRestClientConfig extends AbstractConfig {
  ...
  public RbacRestClientConfig(Map<?, ?> props) {
    super(CONFIG, props);
    validate();
  }

  private void validate() {
    if (getInt(RbacRestClientConfig.HTTP_REQUEST_TIMEOUT_MS_CONFIG) >
        getInt(RbacRestClientConfig.REQUEST_TIMEOUT_MS_CONFIG))
      throw new ConfigException(RbacRestClientConfig.HTTP_REQUEST_TIMEOUT_MS_CONFIG +
          " config value should be less than or equal to " + RbacRestClientConfig.REQUEST_TIMEOUT_MS_CONFIG);
  }
