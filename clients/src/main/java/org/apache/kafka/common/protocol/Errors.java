...
public enum Errors {
    ...
    MEMBER_ID_MISMATCH(81, "The group.instance.id is already in the consumer group, " +
            "however the corresponding member.id is not matching the record on coordinator",
            MemberIdMismatchException::new),
    GROUP_INSTANCE_ID_NOT_FOUND(82, "Some group.instance.id specified in the request are not found",
